   ...
   return (
      <div className="container mx-auto flex flex-col gap-5">
         <div className="relative rounded-[12px] overflow-hidden">
            ...
            <div className="text-[#fff] flex items-end absolute bottom-0 w-full h-1/2 bg-gradient-to-t from-black to-transparent">
               <div className="grid grid-cols-2 p-5">
                  <div className="py-1 flex flex-col sm:gap-2 justify-center">
                     <div className="flex gap-3 items-center">
                        <FaStar className=" text-amber-300" />
                        <p className="text-[18px]">{data?.vote_average}</p>
                     </div>

                     <div className="flex gap-3 items-center">
                        <TbMoneybag className="" />
                        <strong className="">{data?.budget?.toLocaleString()} USD</strong>
                     </div>
                     ...
                     <div className="flex gap-3 items-center">
                        ...
                        <p>{`${Math.floor(data?.runtime / 60)} hour ${data?.runtime % 60} minute`}</p>
                     </div>
                  ...
                  <div className="flex flex-col md:gap-4 justify-end">
                     ...
                     <p className="text-text text-clip line-clamp-1">{data?.overview}</p>
                  </div>
               </div>
            </div>
         </div>
         ...
         <div className="flex flex-col gap-5">
            <h3 className="text-2xl text-[#fff] font-bold ">Производственные компании</h3>
         ...
         <div>
            <h3 className="text-[#fff] text-2xl font-bold">Кадры из фильма</h3>
         </div>
         ...
         <div className="mb-5">
            <h3 className="text-2xl font-bold text-[#fff] mb-5">Похожий</h3>
